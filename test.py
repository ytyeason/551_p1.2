...
print(x_train)
print(y_train)
nbChild = [lst[1] for lst in x_train]
controv = [lst[2] for lst in x_train]
root = [lst[3] for lst in x_train]
y = []
for lst in y_train:
    y.append(lst)

# plt.title("Number of Children vs Popularity")
# plt.plot(nbChild,y,'g^')
# plt.xlabel('number of children')
# plt.ylabel('popularity')
# plt.show()

# plt.title("Controversiality vs. Popularity")
# plt.plot(controv, y, 'g^')
# plt.xlabel('controversiality')
# plt.ylabel('popularity')
# plt.show()

# plt.title("Is_root vs. Popularity")
# plt.plot(root, y, 'g^')
# plt.xlabel('is_root')
# plt.ylabel('popularity')
# plt.show()

logChild = [np.log(lst[1]+1) for lst in x_train]
# justify +1: the number of children might be 0, log(0) is undefined
plt.title("Logarithm of (Number of Children + 1) vs. Popularity")
plt.plot((logChild), y, 'g^')
plt.xlabel('logarithm of number of children')
plt.ylabel('popularity')
plt.show()
